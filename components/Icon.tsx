...
interface IconProps {
  type: 'search' | 'bolt' | 'network_intelligence' | 'voice_chat' | 'chat' | 'spark' | 'image' | 'google' | 'send' | 'dashboard' | 'article' | 'analytics' | 'integrations' | 'settings' | 'bell' | 'chevron-down' | 'edit-document' | 'close' | 'trash' | 'pencil' | 'magic' | 'refresh' | 'copy' | 'check' | 'home' | 'users' | 'help' | 'logout' | 'calendar' | 'plus' | 'arrow-up' | 'arrow-down' | 'dots-vertical' | 'arrow-left' | 'arrow-right' | 'chart-bar' | 'desktop' | 'mobile' | 'sun' | 'moon' | 'share' | 'bookmark' | 'thumb-up' | 'whatsapp' | 'twitter' | 'facebook' | 'linkedin' | 'menu' | 'leads' | 'github' | 'bookmark-filled' | 'speakerphone' | 'trending-up' | 'headphones' | 'play' | 'pause' | 'stop';
  className?: string;
}

// FIX: Added return statement, completed icons object, and added default export.
  ...
  const icons: Record<IconProps['type'], React.ReactNode> = {
    ...
    network_intelligence: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
            ...
            <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM12 12.75v.007A.75.75 0 0 1 11.25 12h-1.5a.75.75 0 0 1-.75-.75V9.75a.75.75 0 0 1 .75-.75h.007a.75.75 0 0 1 .75.75v3Z" />
        </svg>
    ),
    voice_chat: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.76 9.76 0 0 1-2.555-.337A5.972 5.972 0 0 1 5.41 20.97a5.969 5.969 0 0 1-.474-.065 4.48 4.48 0 0 0 .978-2.025c.09-.455.09-.934.09-1.425v-2.288c0-.684-.274-1.343-.756-1.824a4.5 4.5 0 0 1-1.824-.756 4.5 4.5 0 0 1-1.082-5.986 4.49 4.49 0 0 1 5.23-2.423c.33.055.654.11.974.175 2.13.372 4.24 1.543 5.86 3.464.64.787 1.157 1.67 1.518 2.592C20.666 9.404 21 10.684 21 12Z" />
        </svg>
    ),
    chat: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    ...
    'refresh': (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 11.664 0l3.181-3.183m-4.991-2.696-3.182-3.182a8.25 8.25 0 0 0-11.664 0l-3.181 3.182" />
        </svg>
    ),
    'copy': (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    ...
    speakerphone: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6a7.5 7.5 0 1 0 0 12h-3a7.5 7.5 0 0 0 0-12h3Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 12H21M17.25 6H21M17.25 18H21" />
      </svg>
    ),
    'trending-up': (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
